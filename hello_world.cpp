...
static DataRef<double>* dref = NULL;
                        ...
                        char *		outDesc)
{
    ...
    dref = new DataRef<double>("sim/flightmodel/position/longitude", ReadOnly);
